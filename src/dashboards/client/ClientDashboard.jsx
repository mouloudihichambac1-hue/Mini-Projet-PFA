...
function ClientDashboard() {
  ...
  const menuItems = [
    { path: '/dashboard/client', label: 'Explorer les Biens', icon: <IconSearch /> },
    { path: '/dashboard/client/favorites', label: 'Mes Favoris', icon: <IconHeart /> },
    { path: '/dashboard/client/visits', label: 'Mes Visites', icon: <IconCalendar /> },
    { path: '/dashboard/client/messages', label: 'Messagerie', icon: <IconMessage /> },
    { path: '/dashboard/client/preferences', label: 'Mes Préférences', icon: <IconSettings /> },
  ];
